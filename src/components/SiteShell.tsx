...
const AMBIENT_INGREDIENTS = [
  ['jaggery', 6, 0, 84, 13, 12], ['mango', 14, 7, 84, -10, 14],
  ['salt', 23, 14, 84, 9, 9], ['chilli', 32, 21, 84, -14, 15],
  ['neem', 42, 28, 84, 12, 13], ['jamun', 53, 35, 84, -9, 11],
  ['mango', 64, 42, 84, 14, 12], ['jaggery', 75, 49, 84, -11, 10],
  ['chilli', 86, 56, 84, 13, 14], ['salt', 95, 63, 84, -12, 8],
  ['neem', 10, 70, 84, 10, 11], ['jamun', 28, 77, 84, -13, 9],
] as const;
